/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: cab8011f475914a52fbd92c5ddf48527)
// Runtime types generated with workerd@1.20260825.1 2026-07-17 nodejs_compat
interface __BaseEnv_Env {
	FILES: R2Bucket;
	DB: D1Database;
	FILE_BROWSER_RATE_LIMITER: RateLimit;
	ADMIN_LOGIN_RATE_LIMITER: RateLimit;
	INVITATION_EXCHANGE_RATE_LIMITER: RateLimit;
	PUBLIC_FILE_RATE_LIMITER: RateLimit;
	UPLOAD_MUTATION_RATE_LIMITER: RateLimit;
	DELETE_MUTATION_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	MAX_STORAGE_BYTES: "3221225472";
	MAX_FILE_BYTES: "52428800";
	FILE_RETENTION_SECONDS: "7776000";
	RESERVATION_TTL_SECONDS: "900";
	UPLOAD_RESERVATION_WINDOW_SECONDS: "600";
	UPLOAD_RESERVATION_LIMIT: "10";
	UPLOAD_HOURLY_WINDOW_SECONDS: "3600";
	UPLOAD_HOURLY_BYTES: "524288000";
	UPLOAD_DAILY_WINDOW_SECONDS: "86400";
	UPLOAD_DAILY_BYTES: "1073741824";
	INVITATION_MIN_TTL_SECONDS: "86400";
	INVITATION_DEFAULT_TTL_SECONDS: "604800";
	INVITATION_MAX_TTL_SECONDS: "31536000";
	INVITATION_DEFAULT_MAX_FILES: "10";
	INVITATION_MAX_FILES: "100";
	INVITATION_DEFAULT_MAX_BYTES: "314572800";
	UPLOAD_SESSION_TTL_SECONDS: "43200";
	ADMIN_SESSION_TTL_SECONDS: "14400";
	CLIENT_MAX_FILES_PER_BATCH: "10";
	CLIENT_MAX_PARALLEL_UPLOADS: "2";
	MEDIA_PREVIEW_CACHE_SECONDS: "3600";
	PUBLIC_CONFIG_CACHE_SECONDS: "60";
	CLEANUP_BATCH_LIMIT: "100";
	DELETED_METADATA_RETENTION_SECONDS: "604800";
	FAILED_UPLOAD_METADATA_RETENTION_SECONDS: "604800";
	CLEANUP_RUN_RETENTION_SECONDS: "2592000";
	INVITATION_HISTORY_RETENTION_SECONDS: "7776000";
	RECONCILE_METADATA_LIMIT: "500";
	RECONCILE_OBJECT_LIMIT: "1000";
	RECONCILE_PAGE_BUDGET: "10";
	RECONCILE_ORPHAN_GRACE_SECONDS: "3600";
	UPLOADS_ENABLED: "true";
	UPLOAD_ORIGIN: "https://upload.jwander.net";
	CDN_ORIGIN: "https://cdn.jwander.net";
	TURNSTILE_SITE_KEY: "0x4AAAAAAD3nBLCS0pyrqnEn";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAX_STORAGE_BYTES" | "MAX_FILE_BYTES" | "FILE_RETENTION_SECONDS" | "RESERVATION_TTL_SECONDS" | "UPLOAD_RESERVATION_WINDOW_SECONDS" | "UPLOAD_RESERVATION_LIMIT" | "UPLOAD_HOURLY_WINDOW_SECONDS" | "UPLOAD_HOURLY_BYTES" | "UPLOAD_DAILY_WINDOW_SECONDS" | "UPLOAD_DAILY_BYTES" | "INVITATION_MIN_TTL_SECONDS" | "INVITATION_DEFAULT_TTL_SECONDS" | "INVITATION_MAX_TTL_SECONDS" | "INVITATION_DEFAULT_MAX_FILES" | "INVITATION_MAX_FILES" | "INVITATION_DEFAULT_MAX_BYTES" | "UPLOAD_SESSION_TTL_SECONDS" | "ADMIN_SESSION_TTL_SECONDS" | "CLIENT_MAX_FILES_PER_BATCH" | "CLIENT_MAX_PARALLEL_UPLOADS" | "MEDIA_PREVIEW_CACHE_SECONDS" | "PUBLIC_CONFIG_CACHE_SECONDS" | "CLEANUP_BATCH_LIMIT" | "DELETED_METADATA_RETENTION_SECONDS" | "FAILED_UPLOAD_METADATA_RETENTION_SECONDS" | "CLEANUP_RUN_RETENTION_SECONDS" | "INVITATION_HISTORY_RETENTION_SECONDS" | "RECONCILE_METADATA_LIMIT" | "RECONCILE_OBJECT_LIMIT" | "RECONCILE_PAGE_BUDGET" | "RECONCILE_ORPHAN_GRACE_SECONDS" | "UPLOADS_ENABLED" | "UPLOAD_ORIGIN" | "CDN_ORIGIN" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "DELETE_TOKEN_PEPPER" | "IP_HASH_PEPPER" | "ADMIN_TOKEN">> {}
}
